...
search_URL = "https://www.google.com/search?q=dhanush+personal+image&tbm=isch&sa=X&ved=2ahUKEwj-6oKO2r__AhX9amwGHdLuAYwQ0pQJegQIDRAB"
...
#//*[@id="Sva75c"]/div[2]/div[2]/div[2]/div[2]/c-wiz/div/div/div/div[3]/div[1]/a/img[1]
        try:
            imageElement = driver.find_element(by=By.XPATH, value="""//*[@id="Sva75c"]/div[2]/div[2]/div[2]/div[2]/c-wiz/div/div/div/div[3]/div[1]/a/img[1]""")
...
for i in range(51,104):
    ...
    #//*[@id="islrg"]/div[1]/div[51]/div[50]
        ...
        previewImageXPath = '//*[@id="islrg"]/div[1]/div[51]/div[' + str(i-50)+ ']/a[1]/div[1]/img'
        previewImageElement = driver.find_element(by=By.XPATH, value=previewImageXPath)
        previewImageURL = previewImageElement.get_attribute("src")
...
#//*[@id="Sva75c"]/div[2]/div/div[2]/div[2]/div[2]/c-wiz/div/div/div/div[3]/div[1]/a/img[2]
    ...
    while True:
        try:
            imageElement = driver.find_element(by=By.XPATH, value="""//*[@id="Sva75c"]/div[2]/div/div[2]/div[2]/div[2]/c-wiz/div/div/div/div[3]/div[1]/a/img[1]""")
            imageURL= imageElement.get_attribute('src')
...
for i in range(105,208):
    ...
    #//*[@id="islrg"]/div[1]/div[52]/div[79]/a[1]/div[1]/img
        ...
        previewImageXPath = '//*[@id="islrg"]/div[1]/div[52]/div[' + str(i-104)+ ']/a[1]/div[1]/img'
        previewImageElement = driver.find_element(by=By.XPATH, value=previewImageXPath)
        previewImageURL = previewImageElement.get_attribute("src")
    except:
        print('some error')
...
for i in range(209,312):
    ...
    try:
        xPath='//*[@id="islrg"]/div[1]/div[53]/div['+str(i-208)+']'

    #//*[@id="islrg"]/div[1]/div[53]/div[1]
    #//*[@id="islrg"]/div[1]/div[53]/div[2]
    #//*[@id="islrg"]/div[1]/div[53]/div[3]
    #//*[@id="islrg"]/div[1]/div[53]/div[67]
    #//*[@id="islrg"]/div[1]/div[53]/div[104]
    #
    #//*[@id="islrg"]/div[1]/div[54]/div[1]
    #//*[@id="islrg"]/div[1]/div[54]/div[2]
    #//*[@id="islrg"]/div[1]/div[54]/div[1]/a[1]/div[1]/img
    #//*[@id="islrg"]/div[1]/div[54]/div[103]

    #//*[@id="islrg"]/div[1]/div[53]/div[1]/a[1]/div[1]/img
    #//*[@id="islrg"]/div[1]/div[53]/div[2]/a[1]/div[1]/img
    #//*[@id="islrg"]/div[1]/div[53]/div[3]/a[1]/div[1]/img
    #
    #

        previewImageXPath = '//*[@id="islrg"]/div[1]/div[53]/div[' + str(i-208)+ ']/a[1]/div[1]/img'
        previewImageElement = driver.find_element(by=By.XPATH, value=previewImageXPath)
        previewImageURL = previewImageElement.get_attribute("src")
    except:
        print('some error')
...
for i in range(313,415):
    if i%25==0:
        continue
    try:
        xPath='//*[@id="islrg"]/div[1]/div[54]/div['+str(i-312)+']'
    ...
    #
        ...
        previewImageXPath = '//*[@id="islrg"]/div[1]/div[54]/div[' + str(i-312)+ ']/a[1]/div[1]/img'
        previewImageElement = driver.find_element(by=By.XPATH, value=previewImageXPath)
        previewImageURL = previewImageElement.get_attribute("src")
    except:
        print('some error')
